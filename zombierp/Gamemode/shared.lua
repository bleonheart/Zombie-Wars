...
PNRP.Skills = {}
PNRP.Skills["Scavenging"] = {
	name = "Scavenging",
	desc = "Better scavenging through experience.",
	basecost = 150,
	maxlvl = 5,
	class = nil
}

PNRP.Skills["Endurance"] = {
	name = "Endurance",
	desc = "Staying on your feet longer, to survive better",
	basecost = 100,
	maxlvl = 6,
	class = {TEAM_WASTELANDER}
}

PNRP.Skills["Athletics"] = {
	name = "Athletics",
	desc = "Running a bit faster always helps.",
	basecost = 100,
	maxlvl = 5,
	class = nil
}

PNRP.Skills["Weapon Handling"] = {
	name = "Weapon Handling",
	desc = "Accuracy with firearms.  Who wouldn't want that?",
	basecost = 100,
	maxlvl = 5,
	class = nil
}

PNRP.Skills["Construction"] = {
	name = "Construction",
	desc = "Know-how to make things cost less.",
	basecost = 100,
	maxlvl = 5,
	class = {TEAM_ENGINEER}
}

PNRP.Skills["Backpacking"] = {
	name = "Backpacking",
	desc = "Knowing how to pack is great for carrying more.",
	basecost = 50,
	maxlvl = 5,
	class = nil
}

PNRP.Skills["Animal Husbandry"] = {
	name = "Animal Husbandry",
	desc = "Like cattle rearing, but in worm form!",
	basecost = 150,
	maxlvl = 5,
	class = {TEAM_SCIENCE}
}
...
PNRP.Skills["Mining"] = {
	name = "Mining",
	desc = "Get the most out of your sonic miners!",
	basecost = 150,
	maxlvl = 5,
	class = {TEAM_SCAVENGER}
}

PNRP.Skills["Farming"] = {
	name = "Farming",
	desc = "Take care of those plants less.  God yes...",
	basecost = 150,
	maxlvl = 5,
	class = {TEAM_CULTIVATOR}
}

PNRP.Skills["Salvaging"] = {
	name = "Salvaging",
	desc = "Lose less when taking stuff apart!",
	basecost = 100,
	maxlvl = 5,
	class = nil
}

PNRP.Skills["Strength"] = {
	name = "Strength",
	desc = "Make it hurt when you hit!",
	basecost = 150,
	maxlvl = 5,
	class = nil
}
...
--Resource models
PNRP.JunkModels = {"models/props_junk/TrashCluster01a.mdl", "models/Gibs/helicopter_brokenpiece_03.mdl"}
PNRP.ChemicalModels = {"models/props_junk/garbage128_composite001c.mdl", "models/Gibs/gunship_gibs_sensorarray.mdl", "models/Gibs/gunship_gibs_eye.mdl"}
PNRP.SmallPartsModels = {"models/props_combine/combine_binocular01.mdl", "models/Gibs/Scanner_gib01.mdl", "models/Gibs/Scanner_gib05.mdl"}
PNRP.HullList = {"models/props_vehicles/car001a_hatchback.mdl", "models/props_vehicles/car002a_physics.mdl", "models/props_vehicles/car002b_physics.mdl", "models/props_vehicles/car003a_physics.mdl", "models/props_vehicles/car003b_physics.mdl", "models/props_vehicles/car004a_physics.mdl", "models/props_vehicles/car004b_physics.mdl", "models/props_vehicles/car005a_physics.mdl", "models/props_vehicles/car005b_physics.mdl", "models/props_vehicles/truck001a.mdl", "models/props_vehicles/truck002a_cab.mdl", "models/props_vehicles/truck003a.mdl", "models/props_vehicles/van001a.mdl", "models/props_vehicles/van001a_nodoor.mdl", "models/vehicles/vehicle_van.mdl", "models/buggy.mdl", "models/airboat.mdl", "models/vehicle.mdl"}
--Default weapons
PNRP.DefWeps = {"weapon_physcannon", "weapon_physgun", "weapon_pnrp_fists", "weapon_simplekeys", "gmod_camera", "gmod_tool"}
--Friendly NPC Class names
PNRP.friendlies = {"npc_floor_turret", "npc_hdvermin", "npc_hdvermin_fast", "npc_hdvermin_poison", "npc_petbird_crow", "npc_petbird_gull", "npc_petbird_pigeon"}
--[[					
...
function GM:StartEntityDriving(ent, ply)
	if ply:IsAdmin() and GetConVarNumber("pnrp_adminTouchAll") == 1 then drive.Start(ply, ent) end
end

function PNRP.FindAmmoType(id, class)
	if id then if PNRP.Items[id].Type == "weapon" then return PNRP.Weapons[id].AmmoType end end
end
...
function toangle(angleStr)
	...
	if isstring(angleStr) then
		...
		if #Tbl < 2 then Tbl = string.Explode(",", angleStr) end
