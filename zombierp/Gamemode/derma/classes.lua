...
function PNRP.ClassMenu(ply)
	...
	class_Frame.Paint = function() surface.SetDrawColor(50, 50, 50, 0) end
	...
	wastelanderPanel.Paint = function() draw.RoundedBox(6, 0, 0, wastelanderPanel:GetWide(), wastelanderPanel:GetTall(), Color(180, 180, 180, 255)) end
	...
	scavengerPanel.Paint = function() draw.RoundedBox(6, 0, 0, scavengerPanel:GetWide(), scavengerPanel:GetTall(), Color(180, 180, 180, 255)) end
	...
	sciencePanel.Paint = function() draw.RoundedBox(6, 0, 0, sciencePanel:GetWide(), sciencePanel:GetTall(), Color(180, 180, 180, 255)) end
	...
	engineerPanel.Paint = function() draw.RoundedBox(6, 0, 0, engineerPanel:GetWide(), engineerPanel:GetTall(), Color(180, 180, 180, 255)) end
	...
	cultivatorPanel.Paint = function() draw.RoundedBox(6, 0, 0, cultivatorPanel:GetWide(), cultivatorPanel:GetTall(), Color(180, 180, 180, 255)) end
	...
	local zombiePanel = vgui.Create("DPanel")
	zombiePanel:SetTall(75)
	zombiePanel.Paint = function() draw.RoundedBox(6, 0, 0, zombiePanel:GetWide(), zombiePanel:GetTall(), Color(180, 180, 180, 255)) end
	pnlList:AddItem(zombiePanel)
	zombiePanel.Icon = vgui.Create("SpawnIcon", zombiePanel)
	zombiePanel.Icon:SetModel("models/Gibs/HGIBS.mdl")
	zombiePanel.Icon:SetPos(3, 5)
	zombiePanel.Icon:SetToolTip(nil)
	zombiePanel.Icon.DoClick = function()
		RunConsoleCommand("team_set_zombie")
		class_Frame:Close()
	end

	zombiePanel.Title = vgui.Create("DLabel", zombiePanel)
	zombiePanel.Title:SetPos(90, 5)
	zombiePanel.Title:SetText("Zombie")
	zombiePanel.Title:SetColor(team.GetColor(TEAM_ZOMBIE))
	zombiePanel.Title:SizeToContents()
	zombiePanel.Title:SetContentAlignment(5)
	zombiePanel.Description = vgui.Create("DLabel", zombiePanel)
	zombiePanel.Description:SetPos(200, 5)
	zombiePanel.Description:SetText("Test Description")
	zombiePanel.Description:SetColor(Color(0, 0, 0, 255))
	zombiePanel.Description:SizeToContents()
	zombiePanel.Description:SetContentAlignment(5)
end
